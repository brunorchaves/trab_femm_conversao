"""
composite_figure.py — Gera figura composta 1×3 para o relatório:
  (a) Mapa de densidade de campo |B| (density_plot_screenshot.png)
  (b) Detalhe de 3 ranhuras do estator com cotas
  (c) Detalhe de 3 barras do rotor com cotas

Saída: results/motor_composite_figure.png
"""
import os, math
import numpy as np
import matplotlib
